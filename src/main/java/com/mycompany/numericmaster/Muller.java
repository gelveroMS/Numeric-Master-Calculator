...
public class Muller extends javax.swing.JPanel {

    // Declare pointer to previous panel
    private JPanel pointerToPreviousPanel;
    
    // Declare pointer to its second panel
    private MullerPanel2 mullerPanel2;
    ...
    public Muller() {
        ...
        mullerPanel2 = new MullerPanel2();
        mullerPanel2.setVisible(false);
        
        // add the panel here
        add(mullerPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1280, 720));
        
        // connects the the second panel to the first panel
        mullerPanel2.setPointerToPreviousPanel(userInputPanel);
    ...
    //  displays operator on function input
    public void displayOnFunctionInput(JLabel operator) {
        
        // displays specific operator chosen by the user
        if(operator.getText().equals("^")) {
            functionInput.setText(functionInput.getText() + operator.getText() + "()");
            
            // move the caret position for user convenience
    ...
    private void initComponents() {
        ...
        mullerBackLblBtn = new javax.swing.JLabel();
        ...
        userInputPanel.add(generateFunctionLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 360, -1, -1));
        ...
        userInputPanel.add(clearInputFields, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 360, -1, -1));

        mullerBackLblBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/BackBtnenter.png"))); // NOI18N
        mullerBackLblBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                mullerBackLblBtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                mullerBackLblBtnMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                mullerBackLblBtnMousePressed(evt);
            }
        });
        userInputPanel.add(mullerBackLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 650, -1, -1));

        functionInput.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        userInputPanel.add(functionInput, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 210, 360, 50));
        ...
        userInputPanel.add(plusLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 280, 20, -1));
        ...
        userInputPanel.add(minusLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 10, -1));
        ...
        userInputPanel.add(multiplyLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 280, 20, -1));
        ...
        userInputPanel.add(divideLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 280, 10, -1));
        ...
        userInputPanel.add(exponentLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 280, 20, -1));
        ...
        userInputPanel.add(openingParenthesesLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 280, 20, -1));
        ...
        userInputPanel.add(closingParenthesesLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 280, 20, -1));
        ...
        userInputPanel.add(xRaisedToLblBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 280, 60, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/MULLERS METHOD CALCULATOR.png"))); // NOI18N
        jLabel1.setText("jLabel1");
        userInputPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1280, 720));

        add(userInputPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 720));
    }// </editor-fold>//GEN-END:initComponents

    
    
    
    private void mullerBackLblBtnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mullerBackLblBtnMousePressed
        // hides this panel and show the method selection panel
        setVisible(false);
        pointerToPreviousPanel.setVisible(true);
        functionInput.setText("");
    }//GEN-LAST:event_mullerBackLblBtnMousePressed
    ...
    private void generateFunctionLblMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_generateFunctionLblMousePressed
        ...
        mullerPanel2.setVisible(true);
        
        // parse the user input into a function
        mullerPanel2.displayFunction(functionInput.getText());
    ...
    private void mullerBackLblBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mullerBackLblBtnMouseExited
        // TODO add your handling code here:
        mullerBackLblBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/BackBtn.png"))); // NOI18N
    }//GEN-LAST:event_mullerBackLblBtnMouseExited

    private void mullerBackLblBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mullerBackLblBtnMouseEntered
        // TODO add your handling code here:
        mullerBackLblBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/BackBtnenter.png"))); // NOI18N
    }//GEN-LAST:event_mullerBackLblBtnMouseEntered
    ...
    private javax.swing.JLabel mullerBackLblBtn;
